from xero_agents import (
    create_basic_xero_agent,
    create_contact_manager_agent,
    create_invoice_specialist_agent
)
...
async def demo_basic_agent(mcp_server: MCPServer):
    ...
    for request in requests:
        ...
        try:
            result = await Runner.run(starting_agent=agent, input=request, run_config=config)
